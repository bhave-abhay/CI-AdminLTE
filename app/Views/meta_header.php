...
<head>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?=base_url();?>/vendor/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Theme style -->
  ...
  <!-- overlayScrollbars -->
  <script src="<?=base_url();?>/vendor/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
  <!-- AdminLTE App -->
  <script src="<?=base_url();?>/vendor/AdminLTE/js/adminlte.js"></script>
